    ...
    <div className="mt-32 pb-8 flex flex-col items-center relative z-10">
      ...
      <div className="w-full flex flex-col md:flex-row items-center md:justify-between gap-6">
        ...
        <div className="flex gap-3 order-2 md:order-none">
          <a href="https://github.com/Hen17Ry"><i className="ri-github-fill ri-2x"></i></a>
          <a href="https://www.linkedin.com/in/henry-gossou-71078223b/"><i className="ri-linkedin-fill ri-2x"></i></a>
          <a href="https://wa.me/97290319"><i className="ri-whatsapp-fill ri-2x"></i></a>
        </div>
